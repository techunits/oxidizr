...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Handle.twitter_id'
        db.alter_column(u'twitter_handle', 'twitter_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

        # Changing field 'Tweet.tweet_id'
        db.alter_column(u'twitter_tweet', 'tweet_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'Handle.twitter_id'
        db.alter_column(u'twitter_handle', 'twitter_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True))

        # Changing field 'Tweet.tweet_id'
        db.alter_column(u'twitter_tweet', 'tweet_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True))
