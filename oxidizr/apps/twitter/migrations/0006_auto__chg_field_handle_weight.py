...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Handle.weight'
        db.alter_column(u'twitter_handle', 'weight', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Handle.weight'
        db.alter_column(u'twitter_handle', 'weight', self.gf('django.db.models.fields.FloatField')())
