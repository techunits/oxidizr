...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Handle.url'
        db.alter_column(u'twitter_handle', 'url', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

    def backwards(self, orm):

        # Changing field 'Handle.url'
        db.alter_column(u'twitter_handle', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=254))
